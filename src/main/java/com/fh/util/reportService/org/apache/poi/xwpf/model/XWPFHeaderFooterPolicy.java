package com.fh.util.reportService.org.apache.poi.xwpf.model;
...
//        }
    ...
    private int getRelationIndex(XWPFRelation relation) {
        ...
        Iterator<RelationPart> var3 = this.doc.getRelationParts().iterator();
    ...
    private XWPFParagraph getWatermarkParagraph(String text, int idx) {
        ...
        if (idx == 1) {
            ...
            //margin-left鍜宮argin-top璋冩暣浣嶇疆锛宧eight鍜寃idth璋冩暣澶у皬
    ...
    private void setCTR(CTR r, String text, int idx, String style) {
        ...
        CTFill shapeFill = shape.addNewFill();
        
        shapeFill.setOpacity("0.5");
