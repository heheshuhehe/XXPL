...
var heduiTable="#jidugengxinheduiTable";
var mingxiTable="#qumingXiTable";
var dateNO = "#quaterNO";
var reportType = "qu";
var info = 'quinfo';
var mingxi = 'quMingXi';
	$(function (){
		 ...
		 $("#jidugengxinheduiTable").datagrid({
			 striped: 'true',
		 	 width 	: '100%',
	    	 height : document.documentElement.clientHeight-80
		 });
		 $('#jidugengxinheduiTable').datagrid('hideColumn','fund_code');
		 //初始化明细table

		 $("#qumingXiTable").datagrid({
			 striped: 'true',
		 	 width 	: '100%',
	    	 height : document.documentElement.clientHeight-80
		 });
		$('#qumingXiTable').datagrid('enableCellEditing').datagrid('gotoCell', {
			index: 0,
...
function search1FundDataChkRslt(dateNO,fundCode,fundName){
	...
	var params="reportType=QU&dateNO="+dateNO+"&fundCode="+fundCode+"&heDuiYiZhi=0";;
	 $('#qumingXiTable').datagrid({method:'post',url:"<%=cp%>/xinxipilu/search1FundDataChkRslt?"+params}).datagrid('clientPaging'); 
...
<body>
	<div id="tabsidk" class="easyui-tabs" >
		<div title="核对" style="padding: 5px">
			<div title="季度更新核对主页" style="padding: 5px">
				<div style="margin-top: 5px; margin-bottom: 5px;">
					<span>季度:</span>  <input class="easyui-combobox" name="quaterNO"
						...
						data-options="
									  ...
									  textField: 'value',
									  mode:'local',
                                      url:'<%=cp%>/xinxipilujibao/getDateOptions?date_Type=quaterGengXin',  
                                 	  method:'get',
									  multiple:false,
									  width:150,
...
<!-- 					<span  >清单:</span>  <input class="easyui-combobox" style="width:90px;" name="thelist"
				...
				<span>投监核对:</span> <input class="easyui-combobox" style="width:125px;" name="ivsp_chk_rslt_code"
					...
					<a href="javascript:void(0);" class="easyui-linkbutton"
						data-options="iconCls:'icon-search'" onclick="searchdata('quinfo','<%=cp%>')">查询</a><span>&nbsp&nbsp&nbsp&nbsp</span> 
<!-- 					<a href="javascript:void(0);" class="easyui-linkbutton"
...
<!-- 					<a href="javascript:void(0);" class="easyui-linkbutton"
					...
					<a href="javascript:void(0);" class="easyui-linkbutton"
						data-options="iconCls:'icon-arrow_down'" onclick="exportDiscSitu(reportType,'<%=cp%>',dateNO)">导出当前列表</a><span>&nbsp&nbsp</span> 	
				</div>
				<div style="margin-top: 10px;">
                    <table 	id="jidugengxinheduiTable"						
...
<!-- 								<th field="fund_stat" 			width="55" sortable="true">		基金状态</th>
 -->								<!-- <th field="fund_type" 			width="80" sortable="true" align="center">基金类型</th> -->
		...
		<div title="明细" style="padding: 5px">
			<div title="季度更新明细" style="padding: 5px">
				...
				<a href="javascript:void(0);" class="easyui-linkbutton"
						data-options="iconCls:'icon-search'" onclick="searchdata('quMingXi','<%=cp%>')">查询</a> 
				<a href="javascript:void(0);" class="easyui-linkbutton"
