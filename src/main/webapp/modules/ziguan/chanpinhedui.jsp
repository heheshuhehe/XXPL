...
/*         $('#dg').datagrid({method:'get',
        ...
        $('#dg').datagrid({method:'post',url:"ziguan/test?"+params}).datagrid('clientPaging'); 
	  }
 }
...
<div id="tabsidk" >
	...
	<div title="开放状态核对" style="padding: 5px">
	   ...
	   <input class="easyui-combobox" name="wb_zth" id="wb_zth"
						data-options="
								  ...
								  textField: 'text',
								  mode:'local',
								  url:'<%=cp%>/ziguan/queryTASelectVal?selectType=03',
		                          method:'post',
								  multiple:false,
								  width:200,
								  filter: function(q, row){
	     ...
	     <input id="wbdate" name="wbdate"
		  ...
		  <span>开放状态</span>
		  <select class="easyui-combobox"  multiple= "multiple" name="zt" id="zt" style="width: 400px">
		  				<option value=" ">--请选择--</option>
		  				<option value="准备期">准备期</option>
					    ...
					    <option value="基金终止">基金终止</option>
					    <option value="最后交易日">最后交易日</option>
	...
	<!-- 		  <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="searchbackups()">存储核对信息</a> -->
		  ...
		  <span style="font-size:8px;">仅显示开放状态不同</span>
	   ...
	   <div style="margin-top: 10px;">
			<table id="dg" style="width: 777px; height: 480px"
				...
				<thead data-options="frozen:true">
					<tr>
					 <th data-options="field:'fund_name',width:180">基金名称</th>
					 <th data-options="field:'c_date',width:100">日期</th>
					 <th data-options="field:'c_port_code',width:100">资产代码</th>
					</tr>
				</thead>
				<thead>
					<tr>
                        <th field="open_stat_word"  width="120px"   rowspan="2">集合日志开放状态</th>
                       
                       <!--  <th field="enddate" width="70px" rowspan="2" data-options="styler:myCellStyler1,formatter:myformatter3">封闭结束日</th> -->
						<th   colspan="3">TA开放状态</th>
						<th field="chk_stat"  width="110px"   rowspan="2">开放状态是否相同</th>
<!-- 					    <th   colspan="3">今日单位净值</th>
					...
					<tr>
					  ...
					  <th field="open_stat_f_ta" width="100px"  data-options="align:'right',formatter:myformatter">分TA</th>
					  <th field="open_stat_z_ta" width="100px"  data-options="align:'right',formatter:myformatter">资管TA</th>
					  <th field="open_stat_zgzta" width="100px"  data-options="align:'right',formatter:myformatter">私募自营TA</th> <!-- ,styler:myCellStyler -->
...
<!--					  <th field="f_netvalue" width="60px" data-options="align:'right',formatter:myformatter1">分TA</th>
					  ...
					  <th field="zjzzl" width="60px"  data-options="align:'right',formatter:myformatter2,styler:myCellStyler">幅度</th>
