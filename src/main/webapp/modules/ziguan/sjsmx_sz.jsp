...
function searchdata(){
    ...
    +"&ywlx="+$("#ywlx").combobox('getValue')+"&type=2";
				...
				<span>交易日期区间</span>
				    ...
				    <span style="margin-left: 15px;">股东账号:</span>
						...
						<input class="easyui-combobox" name="ywlx" id="ywlx" style="width: 200px" data-options="
								  ...
								  textField: 'text',
								  mode:'local',
								 url:'<%=cp%>/guzhidz/getComboBoxSource?tbname=codemanage&code=datacode&name=datavalue&option=where datatype=\'YWLX0\' order by datacode desc',
		                          method:'post',
								  multiple:false,
								  width:100,
								  filter: function(q, row){
					...
					<thead>
						<tr>
							<!-- <th data-options="field:'ck',checkbox:true"></th>  -->
							 <th field="mxzqzh" >股东账号</th>
							<th field="mxzqdm" >证券代码</th>
							<th field="mxsfje" data-options="align:'center',formatter:myformatter">收付净额</th>
							<th field=mxqsbj data-options="align:'center',formatter:myformatter">清算本金</th>
							<th field="mxjyjsf" data-options="align:'center',formatter:myformatter">经手费</th>
							<th field="mxghf" data-options="align:'center',formatter:myformatter">过户费</th>
							<th field="mxjggf" data-options="align:'center',formatter:myformatter">监管费</th>
							<th field="mxyhs" data-options="align:'center',formatter:myformatter">印花税</th>
							<th field="mxsxf"   data-options="align:'center',formatter:myformatter">手续费</th>
							<th field="mxjsf"  data-options="align:'center',formatter:myformatter" >结算费</th>							
							<th field="mxfjsm" >附加说明</th>
							<th field="mxqssl" >清算数量</th>
							<th field="mxcjsl" >成交数量</th>
							<th field="mxqsjg" >清算价格</th>
							<th field="mxcjjg"   >成交价格</th>
							<th field="mxcjrq"   >成交日期</th>
								<th field="mxqsrq" >清算日期</th>
							<th field="mxjsrq" >交收日期</th>
							<th field="mxjydy" >交易单元</th>
