...
function searchdata(){
	...
	if($("#wbdate").combobox('getValue')==''){
		$.messager.alert('提示','请选择交易日期区间！');
		return;
	}
	
		
    var params="zqzh="+$("#zqzh").textbox('getValue')+"&wbdate="+$("#wbdate").combobox('getValue')+"&wbdate_d="+$("#wbdate_d").combobox('getValue')+"&zqdm="+$("#zqdm").textbox('getValue')
    +"&ywlx="+$("#ywlx").combobox('getValue')+"&type=1";
         
                    
    $('#dg').datagrid({method:'get',url:"ziguan/querysjsmx?"+params}).datagrid('clientPaging'); 
}
...
<body>
	<div id="tabsidk"  class="easyui-tabs" style="">
	 <div title="结算明细查询" style="padding: 5px">
				...
				<span>交易日期区间</span>
				     <input id="wbdate" name="wbdate"
						...
						style="width: 120px"></input> 
						 <input id="wbdate_d" name="wbdate_d"
						class="easyui-datebox"
						data-options="formatter:myformatter1,parser:myparser"
						style="width: 120px"></input>
				
				    <span style="margin-left: 15px;">股东账号:</span>
						<input class="easyui-textbox" name="zqzh" id="zqzh">
						<span style="margin-left: 15px;">证券代码:</span>
						<input class="easyui-textbox" name="zqdm" id="zqdm">
						<span style="margin-left: 15px;">业务类型:</span>
						<input class="easyui-combobox" name="ywlx" id="ywlx" style="width: 200px" data-options="
			                      valueField: 'value',
								  textField: 'text',
								  mode:'local',
								 url:'<%=cp%>/guzhidz/getComboBoxSource?tbname=codemanage&code=datacode&name=datavalue&option=where datatype=\'YWLX\' order by datacode desc',
		                          method:'post',
								  multiple:false,
								  width:100,
								  filter: function(q, row){
					...
					<thead>
						<tr>
							<!-- <th data-options="field:'ck',checkbox:true"></th>  -->
							 <th field="zqzh" >股东账号</th>
							<th field="zqdm1" >证券代码</th>
							<th field="sjsf" data-options="align:'center',formatter:myformatter">实际收付（清算金额加各项费用）</th>
							<th field=qsje data-options="align:'center',formatter:myformatter" >清算金额</th>
							<th field="jsf" data-options="align:'center',formatter:myformatter">经手费</th>
							<th field="ghf" data-options="align:'center',formatter:myformatter">过户费</th>
							<th field="zgf" data-options="align:'center',formatter:myformatter" >证管费</th>
							<th field="yhs" data-options="align:'center',formatter:myformatter">印花税</th>
							<th field="sxf"  data-options="align:'center',formatter:myformatter" >手续费</th>
							<th field="jgdm"   >结果代码</th>
							
							<th field="fjsm" >附加说明</th>
							<th field="qylb" >权益类别</th>
							<th field="mmbz" >买卖标志（融资方B/融券方S）</th>
							<th field="sl" >交收数量</th>
							<th field="cjsl"   >成交数量</th>
							<th field="jg1"   >结算价格</th>
								<th field="jg2" >成交价格</th>
							<th field="jyrq" >交易日期</th>
							<th field="qsrq" >清算日期</th>
							<th field="jsrq" >交收日期</th>
							<th field=xwh1   >席位单元</th>
							<th field="xwhy"   >席位单元所属清算编号</th>	
							<th field="jshy" >结算参与人的清算编号</th>
							<th field="ywlx" >业务类型</th>
							<th field="qthe1" >其它金额1</th>
							<th field="zqdm2"   >证券代码2</th>
