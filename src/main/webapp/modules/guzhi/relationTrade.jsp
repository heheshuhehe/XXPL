...
function createwbdata(){
 	...
 	+"&wbdate2="+$("#wbdate2").combobox('getValue')+"&busi_type="+$("#busi_type").combobox('getValue')+"&ye_type="+$("#ye_type").combobox('getValue')+"&jys_type="+$("#jys_type").combobox('getValue');
	 $('#wbdg').datagrid({method:'get',url:'<%=cp%>/guzhidz/queryrelationTrade?'+params}).datagrid('clientPaging');
...
<div id="tabsidk" class="easyui-tabs" style="">
	<div title="关联交易查询" style="padding: 10px">
		<table>
				<tr>
				<td><span>开始日期</span>
					...
					<option value="2">贷方（计提）</option>
					 ...
					 <span> 交易所</span> 	<select id="jys_type" class="easyui-combobox" name="jys_type" style="width: 100px;" >
					<option value="1">深交所</option>
					<option value="2">港交所</option>
					</select>
			     </td>
					<td>
		               <span style="color: red;">*</span>
