 ...
 <body> 
	   <div id="tabsidk" >
					...
					<table  id="dg"  
						...
						<thead>
							<tr>
								...
								<th field="trade_branch" width="60"  hidden="true">交易机构</th>
								<th field="gth" width="100" hidden="true" >普通柜台号</th>
								<!-- <th field="gth_lx" width="150">柜台号类型</th> -->
								<th field="rzrq_gth" width="150" hidden="true">融资融券柜台号</th>
								<th field="stock_option" width="150" hidden="true">个股期权柜台号</th>
								...
								<th field="ma_mail"  hidden="true" >管理人邮箱</th>
							</tr>
						</thead>
					</table>
				</div>
		...
		<div id="dlg" class="easyui-dialog" closed="true" title="添加账套对应关系"
			...
			<span style="margin-left: 75px;display: none">个股期权柜台号: 
		...
		<div id="yhdzhds" class="easyui-dialog" closed="true" title="修改账套对应关系"
			...
			<span style="margin-left: 75px;display: none">&nbsp;交易机构:
			...
			<span style="width:175px;display: none;" >融资融券柜台号:
			...
			<span style="margin-left: 0px;display: none;">管理人邮箱(多个用分号分隔): 
