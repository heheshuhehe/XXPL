...
<script type="text/javascript">
function searchdata(){
   	var params="systype=1&zth="+$("#wb_zth").combobox('getValue');
...
function addinfo(){
	$("#wbzth").combobox('enable');
	 $("#cz").val('add');
	 $("#jyjg").combobox('select','361');
	 $("#ptsubj").textbox('setValue','103106');
	 $("#xysubj").textbox('setValue','103151');
	 $("#ggbfjsubj").textbox('setValue','102131');
	$("#ggbzjsubj").textbox('setValue','103131');
