	  ...
	  if(str==""){
       ...
       if($("#type").combobox('getValue')!=""){
        ...
        if($("#zt").combobox('getValues')!=""){
        	alert($("#zt").combobox('getValues'));
        	params +="&zt="+$("#zt").combobox('getValues');
        }
        $('#dg').datagrid({method:'get',
        	               url:"guzhita/profitdz?"+params,
...
if ($("input[name='ck']:checked").length!=1){
 ...
 function pz_searchdata(){
 		<%--  var account_names = $("#account_names").combobox('getValue');
  		 ...
  		 $('#pzdg').datagrid({url:"<%=cp%>/guzhita/profitdz?"+params}).datagrid('clientPaging'); 
 }
 //分TA 添加配置
 function pz_adddata(){
...
<div id="tabsidk" >
	...
	<div title="货币基金收益核对" style="padding: 5px">
	   <div style="margin-top: 5px; margin-bottom: 5px;">
	   <span style="display: none">账套名称:
	   <input class="easyui-combobox" name="wb_zth" id="wb_zth"
						data-options="
			                      valueField: 'value',
								  textField: 'text',
								  mode:'local',
								  url:'<%=cp%>/guzhita/queryTASelectVal?selectType=02',
		                          method:'post',
								  multiple:false,
								  width:200,
								  filter: function(q, row){
	...
	<!-- 		  <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="searchbackups()">存储核对信息</a> -->
		  ...
		  <span style="font-size:8px;">仅显示差值项</span>
		   <span style="font-size:8px;display:none ">  <input type="checkbox" name="isbd" id="isbd" value="1" style="display: " />
		              只显示单位净值波动超过10%的产品</span>
	   ...
	   <div style="margin-top: 10px;">
			<table id="dg" style="width: 777px; height: 480px"
				...
				<thead data-options="frozen:true">
					<tr>
					 <th data-options="field:'fundname',width:180">基金名称</th> 
					</tr>
				</thead>
				<thead>
					<tr>
					<!-- <th field="fundname"    width="180px"     rowspan="2">基金名称</th> -->
                        ...
                        <th field="fundstatus"  width="60px"   rowspan="2">状态</th>
                       <!--  <th field="enddate" width="70px" rowspan="2" data-options="styler:myCellStyler1,formatter:myformatter3">封闭结束日</th> -->
						...
						<th   colspan="3">产品收益</th>
					    <th   colspan="3">二次分配收益</th>
						<th   colspan="3">万分收益</th>
						<th   colspan="3">年化收益率</th>
						<th   colspan="3">预估收益率</th>
					<!-- 	<th field="remark"    width="180px"     rowspan="2">备注</th> -->
					</tr>
					<tr>
					  <th field="tacode" width="60px" >分TA</th>
					  <th field="zth" width="60px" >估值</th>
					  <th field="zth" width="60px" >账套号</th>
					  
					    <th field="ta_profit" width="90px" data-options="align:'right',formatter:myformatter">分TA</th>
					  <th field="wb_profit" width="90px" data-options="align:'right',formatter:myformatter">估值</th>
					  <th field="cha_profit" width="90px"  data-options="align:'right',formatter:myformatter,styler:myCellStyler">差额</th>
					 
					  <th field="ta_second" width="90px"  data-options="align:'right',formatter:myformatter">分TA</th>
					  <th field="wb_second" width="90px"  data-options="align:'right',formatter:myformatter">估值</th>
					  <th field="cha_second" width="90px"  data-options="align:'right',formatter:myformatter,styler:myCellStyler">差额</th>
					  
					  
					
					  <th field="ta_wfsy" width="90px"   data-options="align:'right',formatter:myformatter1">分TA</th>
					  <th field="wb_wfsy" width="90px"  data-options="align:'right',formatter:myformatter1">估值</th>
					  <th field="cha_wfsy" width="90px"  data-options="align:'right',formatter:myformatter1,styler:myCellStyler">差额</th>
					 
					  <th field="ta_nh" width="90px" data-options="align:'right',formatter:myformatter1">分TA</th>
					  <th field="wb_nh" width="90px" data-options="align:'right',formatter:myformatter1">估值</th>
					  <th field="cha_nh" width="90px" data-options="align:'right',formatter:myformatter1,styler:myCellStyler">差额</th>
				      
				      
				       <th field="ta_yg" width="90px" data-options="align:'right',formatter:myformatter1">分TA</th>
					  <th field="wb_yg" width="90px" data-options="align:'right',formatter:myformatter1">估值</th>
					  <th field="cha_yg" width="90px" data-options="align:'right',formatter:myformatter1,styler:myCellStyler">差额</th>
