...
//得到第一个日期，它有onSelect属性，可以触发第二个日期
 ...
 //获取开始日期
 		...
 		var params = {c_cp_name:$("#c_port_name").combobox('getValue'),wbdate:$("#wbdate").datebox('getValue'),
 				wbdate2:$("#wbdate2").datebox('getValue'),username:$("#guzhiname").datebox('getValue'),systype:'tg'};
 ...
 function exportDBFTG(type) {
	...
	jQuery.download = function(url, data, method){
		...
		if (wbdate == null || wbdate == "") {
 		...
 		var params = {c_cp_name:$("#c_port_name").combobox('getValue'),wbdate:$("#wbdate").datebox('getValue'),wbdate2:$("#wbdate2").datebox('getValue'),username:$("#guzhiname").datebox('getValue'),type:type,systype:'tg'};
...
<div id="tabsidk" class="easyui-tabs" style="">
	  ...
	  <div style="margin-top: 5px; margin-bottom: 5px;">
			<span>产品名称:</span> 
			<input class="easyui-combobox" name="c_port_name"
				id="c_port_name"
				data-options="
				                      valueField: 'value',
									  textField: 'text',
...
<!--                    <th field="id" width="80px">序号</th> -->
						...
						<th field="wb_zth"   hidden="true">账套号</th>
						<th field="tg_zth" >账套号</th>
