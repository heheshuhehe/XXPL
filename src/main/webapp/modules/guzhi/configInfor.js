...
// 管理人档案审核信息
var funcId_A = 'getRecordManagerReview';
//提交审核操作  更新库
...
function createPanel_A() {
	...
	var fm_name = new ListGridField("fm_name", "管理人名称", null, "class_c");
	var record_number = new ListGridField("record_number", "备案编码", 80, "class_c");
	var record_type = new ListGridField("record_type", "材料类型", 80, "class_c");
	var record_name = new ListGridField("record_name", "材料名称", 80, "class_c");
	var record_version = new ListGridField("record_version", "版本号", 80,"class_c");
	var insert_time = new ListGridField("insert_time", "创建时间", 80,"class_c");
	var operator_id = new ListGridField("user_name", "创建人", 80,"class_c");
	var cz = new ListGridField("cz", "操作", null, "class_c");

	var ccc = new ListGrid(fm_name, record_number,record_type, record_name,
			record_version,insert_time, operator_id, cz);
