 ...
 function outFiletg() {
	...
	jQuery.download = function(url, data, method){
      ...
      if(str=="" ){
		 ...
		 //获取开始日期
 		 var params = {zth:$("#zth").combobox('getValue'),d_ywrq:str,ttlz:$("#ttlz").combobox('getValue')};
		 $.download('simu/tgdownloadsmttl',params,'post');
...
<div id="tabsidk" class="easyui-tabs" style="">
	<div title="分红信息" style="padding: 5px">
		   ...
		   <a href="javascript:void(0)" class="easyui-linkbutton"
                data-options="iconCls:'icon-print'" onclick="outFile()">外包导出</a> 
		   <a href="javascript:void(0)" class="easyui-linkbutton"
				...
				<thead>
					<tr>
					   <!--  <th data-options="field:'ck',checkbox:true"></th> -->
						...
						<th field="d_regdate" width="150px">业务日期 </th>
						<th field="wb_zth" width="150px">外包账套号</th>
						<th field="tg_zth" width="150px">托管账套号</th>
						<th field="ztmc" width="150px">账套名称</th>
						<th field="c_fundcode" width="150px">证券上市代码</th>
						<th field="f_totalprofit" width="150px"  data-options="align:'right',formatter:myformatter,styler:myCellStyler">成交金额</th>
						<th field="f_aheadincome" width="150px"  data-options="align:'right',formatter:myformatter,styler:myCellStyler">结算金额</th>
						<th field="d_cdate" width="150px">结算日期</th>
					</tr>
				</thead>
			</table>
		</div>
