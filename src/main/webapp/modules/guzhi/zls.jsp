	  ...
	  if(str==""){
       ...
       if($("#type").combobox('getValue')!=""){
        ...
        $('#dg').datagrid({method:'get',
        	               url:"guzhita/queryTAZQMX?"+params,
...
<div id="tabsidk" >
	...
	<!-- 		  <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="searchbackups()">存储核对信息</a> -->
		  ...
		  <span style="font-size:8px;display: ">只显示单位净值波动超过10%的产品</span>
		    <input type="checkbox" name="sortfd" id="sortfd" value="0" style="display: " />
		  <span style="font-size:8px;display: ">按幅度排序</span>
			...
			<table id="dg" style="width: 777px; height: 480px"
				...
				<thead>
					...
					<!-- <th field="fundname"    width="180px"     rowspan="2">基金名称</th> -->
                        ...
                        <th field="type"  width="80px"   rowspan="2">基金类型</th>
                        <th field="fundstatus"  width="60px"   rowspan="2">TA类型</th>
					...
					<tr>
					  ...
					  <th field="ta_fe" width="90px"  data-options="align:'right',formatter:myformatter">分TA</th>
					  <th field="wb_fe" width="90px"  data-options="align:'right',formatter:myformatter">估值</th>
					  <th field="fe_ce" width="90px"  data-options="align:'right',formatter:myformatter,styler:myCellStyler">差额</th>
					  
					  
					  <th field="ta_jz" width="90px" data-options="align:'right',formatter:myformatter1">分TA</th>
					  <th field="wb_jz" width="90px" data-options="align:'right',formatter:myformatter1">估值</th>
					  <th field="jz_ce" width="90px"  data-options="align:'right',formatter:myformatter1,styler:myCellStyler">差额</th>
					 
					  <th field="ta_zrjz" width="90px"   data-options="align:'right',formatter:myformatter1">分TA</th>
					  <th field="fudu" width="90px"  data-options="align:'right',formatter:myformatter2">幅度</th>
					  <th field="bdpd" width="90px"  data-options="align:'right',formatter:myformatter2,styler:myCellStyler">波动判断</th>
					 
					  <th field="ta_ljjz" width="90px" data-options="align:'right',formatter:myformatter1">分TA</th>
					  <th field="wb_ljjz" width="90px" data-options="align:'right',formatter:myformatter1">估值</th>
					  <th field="ljjz_ce" width="90px" data-options="align:'right',formatter:myformatter1,styler:myCellStyler">差额</th>
